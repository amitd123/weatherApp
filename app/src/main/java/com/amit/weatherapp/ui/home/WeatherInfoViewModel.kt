...
import com.amit.weatherapp.utils.kelvinToCelsius
import com.amit.weatherapp.utils.unixTimestampToDateTimeString
import com.amit.weatherapp.utils.unixTimestampToTimeString
...
class WeatherInfoViewModel : ViewModel() {
    ...
    var weatherInfoLiveData = MutableLiveData<WeatherData>()
     ...
     */
    fun getWeatherInfo(lat : String,long: String, model: WeatherInfoShowModel) {
        ...
        model.getWeatherInfo(lat,long, object :
            ...
            override fun onRequestSuccess(data: WeatherInfoResponse) {
                ...
                weatherInfoLiveData.postValue(null)
